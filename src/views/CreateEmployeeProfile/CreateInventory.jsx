    ...
    <>
      ...
      <CCard className="mb-4">
        <CCardHeader className='d-flex' style={{justifyContent:'space-between'}}>
          ...
          <button className='btn btn-info text-white' style={{height:"50px"}} onClick={()=>navigate('/inventory-list')}>Product List</button>
        </CCardHeader>
        <CCardBody>
          <motion.div>
            <form onSubmit={handleSubmit}>
              <div className="container">
                <div className="row">
                  ...
                  <div className="input-group mb-2 col" style={{ gap: '20px' }}>
                    <label>Inventory Product Description</label>
                    <div>
                      <input
                  ...
                  <div className="input-group mb-2 col" style={{ gap: '20px' }}>
                    <label>Inventory Product Category</label>
                    <div className="">
                      <input
                  ...
                  <div className="input-group mb-2 col" style={{ gap: '20px' }}>
                    <label>Inventory Product Price</label>
                    <div>
                      <input
                  ...
                  <div className="input-group mb-2 mt-4" style={{ gap: '20px' }}>
                    <label>Inventory Product Stock</label>
                    <div>
                      <input
