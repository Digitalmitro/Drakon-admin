              ...
              <tbody>
                {paginatedData.map((res) => (
                  <tr key={res._id}>
                    ...
                    <td style={{ width: '5%' }}>
                      <img src={res.desktop_image} className="img-fluid" alt="Desktop" />
                    </td>
                    <td style={{ width: '5%' }}>
                      <img src={res.mobile_image} className="img-fluid" alt="Mobile" />
                    </td>
                    <td className="d-flex">
                      ...
                      <button
                        onClick={() => navigate(`/update-category/${res._id}`)}
